...
import { CheckCircle2, Circle, Trophy, ChevronDown } from "lucide-react";
                ...
                >
                  ...
                  <div className="flex gap-3 relative z-10">
                    ...
                    <div className="flex-1 space-y-1.5">
                      ...
                      {/* Micro Progress Bar */}
                      {!quest.completed && (
                        <div className="w-full h-1 rounded-full bg-slate-100 dark:bg-zinc-900 overflow-hidden relative">
                          <div
