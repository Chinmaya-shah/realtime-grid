...
import { Users, Copy, Check, LogOut, ShieldAlert, Plus } from "lucide-react";
        ...
        {isGlobal ? (
          ...
          <div className="space-y-4">
            ...
            <div className="relative flex py-1 items-center">
              <div className="flex-grow border-t border-outline/35"></div>
            ...
            <form onSubmit={handleJoinRoom} className="flex gap-2">
              <input
                ...
                className="px-3 py-2 rounded-xl text-[11px] font-mono font-black tracking-widest text-primary w-full focus:outline-none placeholder-slate-400 dark:placeholder-zinc-605 border border-outline bg-transparent neumorphic-item-pressed uppercase"
              />
              <button
                type="submit"
